        ...
        try:
            ...
            if response.status_code == 429:  # Rate limited
                if 'Retry-After' in response.headers:
                    ...
                    logging.warning("Rate limited but no Retry-After header. Waiting 30 seconds...")
                    time.sleep(30)
            else:
                retries += 1
...
# Usage
numpy_base_url = "https://stackoverflow.com/questions/tagged/mocking?tab=active&page=1"
max_questions = 15000
